    ...
    def _build_dilution_aliquots_tab(self, parent):
        ...
        for i in range(8):
            row_vars = {
                ...
                "diluent": tk.StringVar(value=""),
                "plate_col": tk.StringVar(value=""),
        ...
        ttk.Button(presets_row, text="P1", command=lambda: None).pack(
            side="left", expand=True, fill="x", padx=2, ipady=2
        )
        ttk.Button(presets_row, text="P2", command=lambda: None).pack(
            side="left", expand=True, fill="x", padx=2, ipady=2
        )
        ttk.Button(presets_row, text="P3", command=lambda: None).pack(
            side="left", expand=True, fill="x", padx=2, ipady=2
        )
